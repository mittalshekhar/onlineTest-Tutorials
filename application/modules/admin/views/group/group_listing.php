...
<div class="box">
            ...
            <div>
               ...
               <h class="box-title pull-right" style="margin-right: 20px; margin-bottom: 6px;"><a href="<?= base_url('admin/group/add')?>" class="btn btn-info">Add</a></h>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a href="<?= base_url('admin/group/edit/'.$articles->id.'')?>"  class="fa fa-pencil-square-o fadfa" ></a></td>
