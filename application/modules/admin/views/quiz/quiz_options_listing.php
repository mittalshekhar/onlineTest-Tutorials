...
<div class="box">
            ...
            <div>
               ...
               <h class="box-title pull-right" style="margin-right: 20px; margin-bottom: 6px;"><a href="<?= base_url('admin/quiz/add_options')?>" class="btn btn-info">Add</a></h>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td><?=$i?></td>
                  <td><?=$articles->quiz_group;?></td>
                  <td><?=$articles->question;?></td>
                  <td><?=$articles->answer;?></td>
                  <td><?=$articles->options1.','.$articles->options2.','.$articles->options3.','.$articles->options4;?></td>
                  <td><a href="<?= base_url('admin/quiz/edit_options/'.$articles->id.'')?>"  class="fa fa-pencil-square-o fadfa" ></a></td>
