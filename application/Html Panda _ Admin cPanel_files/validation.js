...
var form_validation = function () {
            ...
            var employee_form = function() {
                ...
                form2.validate({
                    ...
                    messages: {
                        ...
                        country_code: {
                            required: jQuery.validator.format("Please select country.")
                        },
                        mobile: {
                            required: jQuery.validator.format("Please enter mobile number.")
                        },
                        state: {
        ...
        var admin_form = function() {
            ...
            form2.validate({
                ...
                messages: {
                    department: {
                        required: jQuery.validator.format("Please select department.")
                    },
                    user_type: {
                        required: jQuery.validator.format("Please select type of user.")
                    },
                    first_name: {
                ...
                submitHandler: function (form) {
                    ...
                    regformhash(form, form.new_password, form.confirm_password); //login.js
                }
            });
        ...
        var profile_password_form = function() {
            ...
            form2.validate({
                ...
                submitHandler: function (form) {
                    ...
                    error2.hide();
                    //form.submit();
                    changepassformhash(form, form.current_password, form.new_password, form.confirm_password); //login.js
                }
            });
        }
